...
sb:"M140.997,75.983l-1.655,15.322l-26.504,26.088H98.759l-5.386,14.079v19.463l-19.05-5.383l21.949-39.342L38.298,73.496l43.481,5.799l-21.121-30.23l57.562,31.06l16.979-19.05h7.869l18.634,8.282L140.997,75.983z"},doit:function(a,g){var d=goodshare,e=b.extend({type:"vk",url:location.href,title:c.title,image:b('meta[property="og:image"]').attr("content"),text:b('meta[name="description"]').attr("content")},b(a).data(),g);if(null===d.popup(link=d[e.type](e))){if(b(a).is("a"))return b(a).prop("href",link),
!0;location.href=link}return!1},vk:function(a){a=b.extend({url:location.href,title:c.title,image:"",text:""},a);return"http://vkontakte.ru/share.php?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)+"&description="+encodeURIComponent(a.text)+"&image="+encodeURIComponent(a.image)+"&noparse=true"},ok:function(a){a=b.extend({url:location.href,text:""},a);return"http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st.comments="+encodeURIComponent(a.text)+"&st._surl="+encodeURIComponent(a.url)},
fb:function(a){a=b.extend({url:location.href,title:c.title,image:"",text:""},a);return"http://www.facebook.com/sharer.php?s=100&p[title]="+encodeURIComponent(a.title)+"&p[summary]="+encodeURIComponent(a.text)+"&p[url]="+encodeURIComponent(a.url)+"&p[images][0]="+encodeURIComponent(a.image)},lj:function(a){a=b.extend({url:location.href,title:c.title,text:""},a);return"http://livejournal.com/update.bml?subject="+encodeURIComponent(a.title)+"&event="+encodeURIComponent('<a href="'+a.url+'">'+a.title+
"</a> "+a.text)+"&transform=1"},tw:function(a){a=b.extend({url:location.href,title:c.title},a);return"http://twitter.com/share?text="+encodeURIComponent(a.title)+"&url="+encodeURIComponent(a.url)},gp:function(a){a=b.extend({url:location.href},a);return"https://plus.google.com/share?url="+encodeURIComponent(a.url)},mr:function(a){a=b.extend({url:location.href,title:c.title,image:"",text:""},a);return"http://connect.mail.ru/share?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)+
...
encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)+"&body="+encodeURIComponent(a.text+'<br/><a href="'+a.url+'">'+a.title+"</a>")},di:function(a){a=b.extend({url:location.href,title:c.title,text:""},a);return"http://digg.com/submit?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},yz:function(a){a=b.extend({url:location.href,title:c.title,text:""},a);return"http://zakladki.yandex.ru/newlink.xml?url="+encodeURIComponent(a.url)+"&name="+encodeURIComponent(a.title)+
"&descr="+encodeURIComponent(a.text)},rd:function(a){a=b.extend({url:location.href,title:c.title,text:""},a);return"http://www.reddit.com/submit?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},sb:function(a){a=b.extend({url:location.href,title:c.title,text:""},a);return"http://surfingbird.ru/share?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},popup:function(a){return f.open(a,"","toolbar=0,status=0,scrollbars=1,width=626,height=436")}};b.each(goodshare.svgicons,
function(a,c){b('SVG[data-type="'+a+'"] PATH').attr("d",c)});b(c).on("click",".goodshare",function(a){a.preventDefault();goodshare.doit(this)})})})(jQuery,document,window);