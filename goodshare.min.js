...
VK={Share:{}},VK.Share.count=function(a,c){b('[data-counter="vk"]').text(e(c))});d('[data-counter="fb"]')&&b.getJSON("http://graph.facebook.com/?id="+encodeURIComponent(location.href)+"&callback=?",function(a){a.shares===f?b('[data-counter="fb"]').text("0"):b('[data-counter="fb"]').text(e(a.shares))});d('[data-counter="ok"]')&&(b.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref="+encodeURIComponent(location.href)+"&callback=?",function(a){}),ODKL={updateCount:function(a,c){b('[data-counter="ok"]').text(e(c))}});
d('[data-counter="tw"]')&&b.getJSON("http://cdn.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(location.href)+"&callback=?",function(a){b('[data-counter="tw"]').text(e(a.count))});d('[data-counter="gp"]')&&b.ajax({type:"POST",url:"https://clients6.google.com/rpc",processData:!0,contentType:"application/json",data:JSON.stringify({method:"pos.plusones.get",id:location.href,params:{nolog:!0,id:location.href,source:"widget",userId:"@viewer",groupId:"@self"},jsonrpc:"2.0",key:"p",apiVersion:"v1"}),
success:function(a){b('[data-counter="gp"]').text(e(a.result.metadata.globalCounts.count))}});d('[data-counter="mr"]')&&b.getJSON("http://connect.mail.ru/share_count?url_list="+encodeURIComponent(location.href)+"&callback=1&func=?",function(a){var c=encodeURIComponent(location.href);for(c in a)if(a.hasOwnProperty(c)){var d=a[c].shares;break}b.isEmptyObject(a)?b('[data-counter="mr"]').text("0"):b('[data-counter="mr"]').text(e(d))});d('[data-counter="li"]')&&b.getJSON("http://www.linkedin.com/countserv/count/share?url="+
encodeURIComponent(location.href)+"&callback=?",function(a){b('[data-counter="li"]').text(e(a.count))});d('[data-counter="tm"]')&&b.getJSON("http://api.tumblr.com/v2/share/stats?url="+encodeURIComponent(location.href)+"&callback=?",function(a){b('[data-counter="tm"]').text(e(a.response.note_count))});d('[data-counter="pt"]')&&b.getJSON("http://api.pinterest.com/v1/urls/count.json?url="+encodeURIComponent(location.href)+"&callback=?",function(a){b('[data-counter="pt"]').text(e(a.count))});d('[data-counter="rd"]')&&
b.getJSON("https://www.reddit.com/api/info.json?url="+encodeURIComponent(location.href)+"&jsonp=?",function(a){a=a.data.children;0===a.length?b('[data-counter="rd"]').text("0"):b('[data-counter="rd"]').text(e(a[0].data.score))});d('[data-counter="su"]')&&b.getJSON("http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="http://www.stumbleupon.com/services/1.01/badge.getinfo?url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(a){a=b.parseJSON(a.query.results.html.body);
a.result.views===f?b('[data-counter="su"]').text("0"):b('[data-counter="su"]').text(e(a.result.views))});d('[data-counter="po"]')&&b.getJSON("http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="https://widgets.getpocket.com/v1/button?count=horizontal&url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(a){b('[data-counter="po"]').text(e(a.query.results.html.body.div.a.span.em.content))});d('[data-counter="sb"]')&&b.getJSON("http://anyorigin.com/dev/get?url="+
