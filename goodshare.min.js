...
encodeURIComponent(location.href)+"&callback=?",function(a){});VK={Share:{}};VK.Share.count=function(a,d){999<d&&999999>=d?b('[data-counter="vk"]').text(d/1E3+"k"):999999<d?b('[data-counter="vk"]').text((d/1E6).toFixed(3)+"M"):b('[data-counter="vk"]').text(d)};b.getJSON("http://graph.facebook.com/?id="+encodeURIComponent(location.href),function(a){999<a.shares&&999999>=a.shares?b('[data-counter="fb"]').text(a.shares/1E3+"k"):999999<a.shares?b('[data-counter="fb"]').text((a.shares/1E6).toFixed(3)+
"M"):b('[data-counter="fb"]').text(a.shares)});b.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref="+encodeURIComponent(location.href)+"&callback=?",function(a){});ODKL={updateCount:function(a,d){999<d&&999999>=d?b('[data-counter="ok"]').text(d/1E3+"k"):999999<d?b('[data-counter="ok"]').text((d/1E6).toFixed(3)+"M"):b('[data-counter="ok"]').text(d)}};b.getJSON("http://cdn.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(location.href)+"&callback=?",function(a){999<a.count&&999999>=
