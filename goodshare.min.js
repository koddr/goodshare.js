...
title:c.title,text:""},a);return"http://surfingbird.ru/share?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)+"&description="+encodeURIComponent(a.text)},popup:function(a){return f.open(a,"","toolbar=0,status=0,scrollbars=0,width=626,height=436")}};b.getJSON("https://vk.com/share.php?act=count&index=1&url="+encodeURIComponent(location.href)+"&callback=?",function(a){});VK={Share:{}};VK.Share.count=function(a,c){999<c&&999999>=c?b('[data-counter="vk"]').text(c/1E3+"k"):999999<
c?b('[data-counter="vk"]').text((c/1E6).toFixed(3)+"M"):b('[data-counter="vk"]').text(c)};b.getJSON("http://graph.facebook.com/?id="+encodeURIComponent(location.href),function(a){999<a.shares&&999999>=a.shares?b('[data-counter="fb"]').text(a.shares/1E3+"k"):999999<a.shares?b('[data-counter="fb"]').text((a.shares/1E6).toFixed(3)+"M"):b('[data-counter="fb"]').text(a.shares)});b.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref="+encodeURIComponent(location.href)+"&callback=?",function(a){});
ODKL={updateCount:function(a,c){999<c&&999999>=c?b('[data-counter="ok"]').text(c/1E3+"k"):999999<c?b('[data-counter="ok"]').text((c/1E6).toFixed(3)+"M"):b('[data-counter="ok"]').text(c)}};b.getJSON("http://cdn.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(location.href)+"&callback=?",function(a){999<a.count&&999999>=a.count?b('[data-counter="tw"]').text(a.count/1E3+"k"):999999<a.count?b('[data-counter="tw"]').text((a.count/1E6).toFixed(3)+"M"):b('[data-counter="tw"]').text(a.count)});
b.ajax({type:"POST",url:"https://clients6.google.com/rpc",processData:!0,contentType:"application/json",data:JSON.stringify({method:"pos.plusones.get",id:location.href,params:{nolog:!0,id:location.href,source:"widget",userId:"@viewer",groupId:"@self"},jsonrpc:"2.0",key:"p",apiVersion:"v1"}),success:function(a){999<a.result.metadata.globalCounts.count&&999999>=a.result.metadata.globalCounts.count?b('[data-counter="gp"]').text(a.result.metadata.globalCounts.count/1E3+"k"):999999<a.result.metadata.globalCounts.count?
b('[data-counter="gp"]').text((a.result.metadata.globalCounts.count/1E6).toFixed(3)+"M"):b('[data-counter="gp"]').text(a.result.metadata.globalCounts.count)}});b.getJSON("http://www.linkedin.com/countserv/count/share?url="+encodeURIComponent(location.href)+"&callback=?",function(a){999<a.count&&999999>=a.count?b('[data-counter="li"]').text(a.count/1E3+"k"):999999<a.count?b('[data-counter="li"]').text((a.count/1E6).toFixed(3)+"M"):b('[data-counter="li"]').text(a.count)});b.getJSON("http://api.pinterest.com/v1/urls/count.json?url="+
encodeURIComponent(location.href)+"&callback=?",function(a){999<a.count&&999999>=a.count?b('[data-counter="pt"]').text(a.count/1E3+"k"):999999<a.count?b('[data-counter="pt"]').text((a.count/1E6).toFixed(3)+"M"):b('[data-counter="pt"]').text(a.count)});b(c).on("click",".goodshare",function(a){a.preventDefault();goodshare.init(this)})})})(jQuery,document,window);
